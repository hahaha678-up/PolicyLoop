...
Usage:
    ...
    python generate_scene_screenshots.py --scene banana_bowl.usda banana_bowl.usda
    python generate_scene_screenshots.py --scene kitchen/banana_bowl.usda /absolute/path/to/scene.usda
...
def main():
    ...
    parser.add_argument("--ignore-files", nargs="*", default=[], help="List of file names to ignore (default: include all scene files)")
    parser.add_argument("--ignore-folders", nargs="*", default=[], help="List of folder names to ignore (default: include all scene folders)")
