...
|:--|:--|:--|:--|:--|
| `BananaInBowlTask` | 1 | 0 | 1 | simple |
| `BananaThenRubiksCubeTask` | 2 | 0 | 2 | simple |
| `BananasInBinThreeTotalTask` | 1 | 2 (counting) | 3 | moderate |
| `RubiksCubeLeftOfBowlTask` | 3 | 1 (spatial) | 4 | moderate |
| `BlockStackingSpecifiedOrderTask` | 3 | 2 (stacking) | 5 | complex |
