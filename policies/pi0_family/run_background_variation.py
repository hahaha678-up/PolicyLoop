...
(per-task random, NOT a matrix sweep), use `policies/pi0_family/run.py --randomize-background`
instead. See docs/background.md → "Choosing a Background Strategy".

Usage:
    $ python policies/pi0_family/run_background_variation.py --headless
    $ python policies/pi0_family/run_background_variation.py --task BananaInBowlTask --headless
...
parser.add_argument("--task", nargs='+', default=['BananaInBowlTask', 'RubiksCubeAndBananaTask'],
...
from policyloop.registrations.droid.auto_env_registrations_bg_variations import auto_register_droid_envs_bg_variations # noqa
from policyloop.core.environments.factory import get_envs_by_tag # noqa
...
auto_register_droid_envs_bg_variations(task_dirs=args_cli.task_dirs, tasks=args_cli.task)
