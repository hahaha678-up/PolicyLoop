...
Usage:
    ...
    $ python policies/pi0_family/run_camera_pose_variation.py --headless

    Run on specific tasks:
    $ python policies/pi0_family/run_camera_pose_variation.py --task BananaInBowlTask --headless
...
parser.add_argument("--output-folder-name", "--output_folder_name", type=str, default=None,
                       help="Output folder name under /policyloop/output. Default is <timestamp>_<policy>_camera_pose_variation.")
...
from policyloop.core.events.reset_camera import reset_camera_pose_uniform # noqa
...
# Update policyloop.constants module settings from command line arguments
