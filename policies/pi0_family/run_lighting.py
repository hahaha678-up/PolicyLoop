...
Usage:
    $ python policies/pi0_family/run_lighting.py --headless
    $ python policies/pi0_family/run_lighting.py --task BananaInBowlTask --headless
...
from policyloop.registrations.droid.auto_env_registrations_lighting_variations import auto_register_droid_envs_light_intensity, auto_register_droid_envs_shadows, auto_register_droid_envs_colored_lights # noqa
