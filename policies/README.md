...
PolicyLoop uses a **server-client architecture**: your model runs as a standalone server process, and PolicyLoop connects to it through a lightweight inference client during evaluation.
