...
from policyloop.constants import ROBOTS_DIR
from policyloop.core.environments.scene_fixture import FRANKA_TABLE_FIXTURE

# Offset of the end-effector control frame relative to base_link.
# DroidCfg.frames publishes this pose as "eef_frame" for downstream code.
...
class DroidIKActionCfg:
    ...
    drifts in orientation and diverges. The relative IK path is unaffected, so
