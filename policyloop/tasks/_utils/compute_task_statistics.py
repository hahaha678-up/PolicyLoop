...
Usage:
    ...
    python compute_task_statistics.py --subfolders benchmark
...
from policyloop.constants import BENCHMARK_TASK_CATEGORIES, DIFFICULTY_THRESHOLDS, SKILL_WEIGHTS
...
def print_full_report(tasks_data: List[Dict[str, Any]], verbose: bool = False):
    ...
    """
    print("\n" + "=" * 80)
    print("POLICYLOOP TASK STATISTICS — FULL REPORT")
