...
from policyloop.core.task.status import StatusCode
from policyloop.core.task.subtask import Subtask
from policyloop.core.task.subtask_utils import *
from policyloop.core.utils.function_loader import func_as_str, get_callable_info
from policyloop.core.world.world_state import WorldState, get_world
...
class ConditionalsStateMachine:
    ...
    def step(self, env_events: list[tuple[str, StatusCode]] | None = None) -> tuple[bool, str, StatusCode, list[tuple[str, StatusCode]]]:
        ...
        if policyloop.constants.VERBOSE and changed:
            self._print_current_state()
        ...
        if done and policyloop.constants.DEBUG:
