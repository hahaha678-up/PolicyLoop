...
from policyloop.core.task.decorators import atomic, composite
from policyloop.core.task.predicate_logic import *
from policyloop.core.task.predicate_logic import _and, _not, gripper_detached
...
def objects_placed_in_container_in_order(
    ...
    ``PolicyLoopEnv._reset_idx`` via ``WorldState.reset_predicate_state``.
    """
    world = get_world(env)
