...
def generate_image_obs_from_cameras(camera_cfgs: List[Any] | Any):
    ...
    Example usage:
        from policyloop.variations.camera import EgocentricWideAngleCameraCfg, EgocentricMirroredWideAngleCameraCfg, EgocentricMirroredCameraCfg
        ...
        for attr_name in dir(camera_cfg_instance):
            if not attr_name.startswith('_'):
                ...
                # if hasattr(attr_value, 'prim_path'):
                    ...
                    # Cameras that render depth (see policyloop.variations.camera.with_depth)
...
def generate_obs_cfg(obs_groups: dict[str, ObsGroup]):
    ...
    Example usage:
        from policyloop.variations.camera import EgocentricWideAngleCameraCfg, EgocentricMirroredWideAngleCameraCfg
        from policyloop.core.observations.image_obs import generate_image_obs_from_cameras, generate_obs_cfg
