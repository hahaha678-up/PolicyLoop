...
"""PolicyLoop environment runtime class.

This module contains the PolicyLoopEnv class which extends ManagerBasedRLEnv
...
class PolicyLoopEnv(ManagerBasedRLEnv):
    """Environment for PolicyLoop evaluation.

    Extends ManagerBasedRLEnv with:
    - Custom recorder manager (PolicyLoopRecorderManager)
    ...
    def load_managers(self):
        ...
        capable PolicyLoopRecorderManager.
        ...
        manager below with PolicyLoopRecorderManager (which opens the real
        ...
        self.recorder_manager = PolicyLoopRecorderManager(self.cfg.recorders, self)
