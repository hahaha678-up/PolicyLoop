...
"""Base configuration classes for PolicyLoop environments.
...
rewards, terminations, and the main PolicyLoopDefaultEnvCfg.
"""
...
from policyloop.core.events.basic_recorders import (
...
from policyloop.core.events.subtask_recorder import SubtaskCompletionRecorderCfg
...
@configclass
class PolicyLoopDefaultEnvCfg(ManagerBasedRLEnvCfg):
    observations = None
    actions = None
    rewards = None
    commands = None
    ...
    def __post_init__(self):
        ...
        if self.recorders is None:
            ...
            enable_subtask_tracking = policyloop.constants.ENABLE_SUBTASK_PROGRESS_CHECKING and self.subtasks is not None
            enable_policy_observations = policyloop.constants.RECORD_IMAGE_DATA
