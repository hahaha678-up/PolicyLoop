...
"""PolicyLoop environment module.

This module provides the core environment infrastructure for PolicyLoop:

- base: Base configuration classes (PolicyLoopDefaultEnvCfg, etc.)
- config: Environment configuration generation and parsing
- env: PolicyLoopEnv runtime class
- factory: EnvFactory for automatic environment creation
- runtime: Environment creation and management utilities
"""

# Base configuration classes
from policyloop.core.environments.base import (
    ActionCfg,
    BaseEventCfg,
    ...
    ObservationCfg,
    RewardsCfg,
    PolicyLoopDefaultEnvCfg,
    TerminationsCfg,
    create_recorder_config,
)

# Configuration generation and parsing
from policyloop.core.environments.config import (
...
from policyloop.core.environments.factory import (
    EnvFactory,
...
# Runtime utilities
from policyloop.core.environments.runtime import (
    check_scene_valid,
    check_terminated,
    create_env,
    end_episode,
