...
# Get the policyloop package root directory (repo root)
PACKAGE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) # policyloop (repo root)

# Get source directory (the policyloop package itself)
SOURCE_DIR = os.path.dirname(os.path.abspath(__file__)) # policyloop/policyloop
